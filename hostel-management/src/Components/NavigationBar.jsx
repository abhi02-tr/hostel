                ...
                <Box>
                    <AppBar position="static" sx={{ background: "white", color: "black" }}>
                        ...
                        <Container maxWidth="xl" >
                            <Toolbar disableGutters sx={{ paddingY: 2, display:"flex", alignItems:"center", justifyContent:"center"  }} >

                                <img src={favicon} alt="Adit Logo" style={{ height: "100px", padding: "10px" }} />
